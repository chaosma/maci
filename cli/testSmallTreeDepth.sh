...
node build/index.js setVerifyingKeys -s 2 -i 1 -m 2 -v 2 -b 1 \
    -p ./zkeys/ProcessMessages_2-2-1-2_test.0.zkey \
    -t ./zkeys/TallyVotes_2-1-2_test.0.zkey  \
...
node build/index.js genProofs \
    ...
    -wp ./zkeys/ProcessMessages_2-2-1-2_test \
    -wt ./zkeys/TallyVotes_2-1-2_test \
    -zp ./zkeys/ProcessMessages_2-2-1-2_test.0.zkey \
    -zt ./zkeys/TallyVotes_2-1-2_test.0.zkey \
    -t tally.json \
    -f proofs/
